...
$result = array('brojfirme' => $_POST['brojfirme'], 'nazivfirme' => $_POST['nazivfirme'], 'sifraopcine' => $_POST['sifraopcine'], 'gender' => $_POST['gender'], 'telefonfirme' => $_POST['telefonfirme'], 'emailfirme' => $_POST['emailfirme'], 'licnibroj' => $_POST['licnibroj'], 'imeiprezimekorisnika' => $_POST['imeiprezimekorisnika'], 'datumrodjenjakorisnika' => $_POST['datumrodjenjakorisnika'], 'gender1' => $_POST['gender1'], 'licnaadresa' => $_POST['licnaadresa'], 'opcinaprebivalista' => $_POST['opcinaprebivalista'], 'kontaktadresa' => $_POST['kontaktadresa'], 'licnipostanskibroj' => $_POST['licnipostanskibroj'], 'mjesto' => $_POST['mjesto'], 'licniemail' => $_POST['licniemail'], 'gender2' => $_POST['gender2'], 'sati' => $_POST['sati'], 'minute' =>  $_POST['minute'], 'osnovosiguranja' => $_POST['osnovosiguranja'], 'zanimanje' => $_POST['zanimanje'], 'gender3' => $_POST['gender3'],'datumprijave' => $_POST['datumprijave'], 'osnovuplate' => $_POST['osnovuplate'],'sifraradnogmjesta' => $_POST['sifraradnogmjesta'], 'stepenuvecanja' => $_POST['stepenuvecanja'], 'potpispodnosioca' => $_POST['potpispodnosioca'], 'datumpodnosioca' => $_POST['datumpodnosioca'], 'imeiprezimesluzbenikaporezneuprave' => $_POST['imeiprezimesluzbenikaporezneuprave'], 'imeiprezimelicakojejepopuniloprijavu' => $_POST['imeiprezimelicakojejepopuniloprijavu'],  'potpissluzbenikaporezneprijave' => $_POST['potpissluzbenikaporezneprijave'], 'datumprijemaprijave' => $_POST['datumprijemaprijave']);
