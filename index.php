    ...
    <tr>
        ...
        <tr>
            ...
            <td colspan="3">1) JIB/JMB
                <input id="jibjmb" placeholder="JIB/JMB" style=" color:blue; outline:none; border:none; font-size:13px; width:150mm; color:blue; text-align:center; color:blue;" type="text" name="brojfirme" required></td>
            </tr>
            <tr>
